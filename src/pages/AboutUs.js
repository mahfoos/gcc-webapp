    ...
    <>
      <section className="about-container" id="about-us">
        ...
        <p className="description">
          With the experience and the aptitude of serving, GC Cargo is the best cargo service provider in Qatar. Specializing in door-to-door, door-to-port delivery with online tracking and online booking platform. GC Cargo functions with the highest confidence and provide a reliable, efficient and low-cost cargo services to both individuals and corporates.
        </p>
        <p className="description">
